...
public class boardGrid : MonoBehaviour
{
    ...
    public void GridStart()
    {
        ...
        for (int x = 0; x < grid_width; x++)
        {
            for (int y = 0; y < grid_height; y++)
            {
                ...
                background.transform.parent = transform; //Makes the child of the grid
            }
        }
    ...
    public void CheckRow(GamePiece piece1, GamePiece piece2)
    {
        ...
        {
            //Debug.Log(pieces[x, piece1.Y].ColorComponent.Color);
        ...
        for (int x = 0; x < grid_width-1; x++)
        {
            //Debug.Log(pieces[x, piece2.Y].ColorComponent.Color);
